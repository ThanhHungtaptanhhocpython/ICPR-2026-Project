...
def _additional_targets(num_frames: int) -> dict:
    """Albumentations targets for applying one sampled transform across all frames."""
    return {f"image{i}": "image" for i in range(1, num_frames)}
...
def get_train_transforms(
    ...
    return A.Compose([
        ...
        ToTensorV2()
    ], additional_targets=_additional_targets(num_frames))
